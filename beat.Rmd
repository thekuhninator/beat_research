...
kbet <- function(gene_counts, annot, output_dir, output_name) 
{
  ...
  file_name <- paste(output_name, '_kbet_plot.png', sep="")
  png(file_name)
...
# let's run t-sne
#sne_path <- tsne_batch(gene_counts, annot, '.', 'tsne_plot')
#tsne_path
```
...
grouped_boxplot <- function(gene_counts, annot, output_dir, output_name) 
{
...
#print(boxplot)data
  file_name <- 'comparative_boxplot.png'
  png(file_name)
  ...
  return(list(boxplot_data, file_name))
...
printImageURI <- function(image_file) {
  image_file <- "C:/Users/Roman/Documents/Work/Depression_and_Immunology/beat/output/dataset_1_comparative_boxplot.png"
